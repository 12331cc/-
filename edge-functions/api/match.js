...
候选人：程志雯，视觉设计 / AIGC 设计方向，1 年视觉设计工作与实习经验。

核心能力：
- 行业与项目背景：覆盖电商、文旅出行、海外社交与跨境电商场景，参与平台及品牌项目落地。
- 视觉设计：活动 H5、运营视觉、品牌 IP、详情页、Banner、社交媒体物料、直播礼物动效。
- AIGC 与动态：Midjourney、Stable Diffusion、ComfyUI、即梦、可灵、Seedance；具备 AI 图片、短视频、直播入场动效、粒子光效、节奏转场和互动视觉包装能力。
- 方法与工作方式：能够完成调研分析、创意发散、AI 生成、视觉精修到动态物料交付的完整流程，关注点击率、停留时长、转化率与 ROI 等指标。
...
5. 证据优先引用非实习项目“海外社交平台斋月裂变活动”；只有该项目不能直接支撑时，才引用飞猪或赫基实习经历。简历中没有“宁德时代”经历，禁止引用该公司。
...
6. 优先使用非实习项目证据；若同一条同时使用非实习与实习证据，先写非实习项目，再写实习经历。
